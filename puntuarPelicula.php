    ...
    <form name="formulario_puntuar"  METHOD="post" ACTION="index.php">
        ...
        <table width="500" border="0" height="0" align="center" cellspacing="0" cellpadding="3">
            ...
            if (isset($puntuar)) {
                ...
                $result_query = $conexion->query($sql_query) or die("Error en la sentencia SQL<br><br>" . $sql_query . "<br><br>");
                $reg_query = $result_query->fetch_array();
                if ($reg_query) { //El usuario ya ha puntuado esa pelicula  -> se actualiza su puntuación
                    ...
                    $result_update = $conexion->query($sql_update) or die("Error en la sentencia SQL<br><br>" . $sql_update . "<br><br>");
                    if (trim($comentario) == "")
                    ...
                    $result_update = $conexion->query($sql_insert) or die("Error en la sentencia SQL<br><br>" . $sql_insert . "<br><br>");
            ...
            $result_pelicula = $conexion->query($sql_pelicula) or die("Error en la sentencia SQL<br><br>" . $sql . "<br><br>");
            $reg_pelicula = $result_pelicula->fetch_array();
            ...
            if ($reg_pelicula) {
                ...
                <tr >
                    ...
                    <td class="datos" width="300"> <?php
                        if ($reg_pelicula["estreno"] == 1)
                            echo "SI";
                        else
                            echo "NO";
                        ?>  </td>
                ...
                $result_puntuacion = $conexion->query($sql_puntuacion) or die("Error en la sentencia SQL<br><br>" . $sql_puntuacion . "<br><br>");
                $reg_puntuacion = $result_puntuacion->fetch_array();
                ...
                $result_mipuntuacion = $conexion->query($sql_mipuntuacion) or die("Error en la sentencia SQL<br><br>" . $sql_mipuntuacion . "<br><br>");
                $reg_mipuntuacion = $result_mipuntuacion->fetch_array();
                if ($reg_mipuntuacion) {
                    ?>
                    <tr class="formulario">
